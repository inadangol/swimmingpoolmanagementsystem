...
if(isset($_POST['update_trainee'])){
    ...
    if($update_query){
        ...
        $message = 'Trainee could not be updated. Error: ' . mysqli_error($conn);
    }
   
    header('location:totalstudent.php?message=' . urlencode( $message));
    ...
    <table>
        ...
        <?php
            ...
            <tr>
                ...
                <td>
                    <a href="totalstudent.php?delete=<?php echo $row['c_id']; ?>" class="delete-btnn"
                    onclick="return confirm('Are you sure you want to delete?');"><i class="fa-sharp fa-solid fa-trash"></i> Delete </a>
                </td>
                <td>
                    <a href="totalstudent.php?edit=<?php echo $row['c_id']; ?>" class="option-btnn"
...
<script>
    ...
    document.querySelector('#close-edit').onclick = () => {
        ...
        window.location.href = 'totalstudent.php';
    }
